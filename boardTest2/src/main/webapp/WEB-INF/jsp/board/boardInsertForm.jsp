		...
		<div class="panel-body">
			...
			<form class="form-horizontal" action="${cpath}/boardInsert" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="writer" name="writer" value="${memberInfo.id}" readonly="readonly">
			    </div>
			  </div>
		  ...
		  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      ...
			      <button type="reset"s onclick="location.href='${cpath}/list'">취소</button>
			    </div>
			  </div>
			</form>
